...
@Component({
    selector: 'app-buy-subscription-partial-payment',
    templateUrl: './buy-subscription-partial-payment.component.html',
    ...
    .section-diff {
      padding: 20px;
      background: #fff;
      box-shadow: 0px 0px 20px -3px #ebe9e9;
      margin-bottom: 20px;
    }
    .section-diff label.m-radio {
      display: block;
      height: 48px;
    ...
    .section-diff label.m-radio span {
      margin: 12px;
    }`
    ],
})

export class BuySubscriptionPartialPaymentComponent implements OnInit, AfterViewInit {
