...
@Component({
    selector: 'app-buy-subscription-two',
    templateUrl: './buy-subscription-two.component.html',
...
export class BuySubscriptionTwoComponent implements OnInit, AfterViewInit {
