...
@Component({
    selector: 'app-buy-subsription-one',
    templateUrl: './buy-subscription-one.component.html',
...
export class BuySubscriptionOneComponent implements OnInit, AfterViewInit {
