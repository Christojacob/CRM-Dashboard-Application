...
@Component({
    selector: 'app-donation-lists',
    templateUrl: './donation-lists.component.html',
    encapsulation: ViewEncapsulation.None,
})
export class DonationListsComponent implements OnInit, AfterViewInit {
    adv = true;
