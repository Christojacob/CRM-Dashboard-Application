...
@Component({
    selector: 'app-primary-country-lists',
    templateUrl: './primary-country-lists.component.html',
    encapsulation: ViewEncapsulation.None,
})
export class PrimaryCountryListsComponent implements OnInit, AfterViewInit {
    adv = true;
            ...
            let datatable = (<any>$('.m_datatables')).mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            method: 'GET',
                            url: apiUrl + 'settings/primary-country',
    ...
    editClick(id) {
        this.router.navigateByUrl('/setting/primary-country/edit/' + id);
    }
