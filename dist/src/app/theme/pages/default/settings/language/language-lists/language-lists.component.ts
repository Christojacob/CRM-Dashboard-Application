...
export class LanguageListsComponent implements OnInit, AfterViewInit {

    constructor(private helper: Helpers, private router: Router, private _languageService: LanguageService) { }
            ...
            let datatable = (<any>$('.m_datatables')).mDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            method: 'GET',
                            url: apiUrl + 'settings/language/fetch',
    ...
    editClick(id) {
        this.router.navigateByUrl('/setting/language/edit/' + id);
    }
    ...
    deleteClick(id) {
        ...
        if (confirm("Are you sure?")) {
            ...
            this._languageService.LanguageDelete(id).subscribe(
                data => {
