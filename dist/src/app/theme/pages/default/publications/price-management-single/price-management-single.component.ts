...
@Component({
    selector: 'app-price-management-single',
    templateUrl: './price-management-single.component.html',
...
export class PriceManagementSingleComponent implements OnInit, AfterViewInit {
