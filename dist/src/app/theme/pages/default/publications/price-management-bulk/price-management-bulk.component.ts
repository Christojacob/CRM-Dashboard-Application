...
@Component({
    selector: 'app-price-management-bulk',
    templateUrl: './price-management-bulk.component.html',
...
export class PriceManagementBulkComponent implements OnInit, AfterViewInit {
