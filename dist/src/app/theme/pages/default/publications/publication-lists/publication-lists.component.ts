...
export class PublicationListsComponent implements OnInit, AfterViewInit {
    adv = true;
    optionField: any = Helpers.datatableOptions();
    hidenFields: any;
    constructor(public _publicationService: PublicationService, private helper: Helpers, private router: Router, private _countryService: CountryService, private _stateService: StateService, private _curd: CommonCrudService) { }
    ...
    ngAfterViewInit() {
        ...
        this.optionField.data.source.read.url = apiUrl + 'publication/list';
        let item = [
            { field: 'PublicationName', title: 'Name' },
            { field: 'Desc', title: 'Description' },
            { field: 'EditionCountry', title: 'Country Name' },
    ...
    deleteClick(id) {
        if (confirm("Are you sure?")) {
            ...
            this._publicationService.PublicationDelete(id).subscribe(
                data => {
