...
const routes: Routes = [
    {
        ...
        "children": [
            {
                "path": "staff\/role",
                "loadChildren": ".\/pages\/default\/staff\/roles\/role-list\/role-lists.module#RoleListsModule"
            },
            {
                "path": "staff",
                "loadChildren": ".\/pages\/default\/staff\/users\/user-lists\/user-lists.module#UserListsModule"
            },
            {
                "path": "staff\/edit\/:StaffId",
                "loadChildren": ".\/pages\/default\/staff\/users\/user-edit\/user-edit.module#UserAddModule"
            },
            {
                "path": "staff\/add",
                "loadChildren": ".\/pages\/default\/staff\/users\/user-add\/user-add.module#UserAddModule"
            },
            {
                "path": "members",
                "loadChildren": ".\/pages\/default\/members/member-lists/member-lists.module#MemberListsModule"
            },
            {
                "path": "members\/create",
                "loadChildren": ".\/pages\/default\/members/member-create/member-create.module#MemberCreateModule"
            },
            {
                "path": "members\/:MemberId",
                "loadChildren": ".\/pages\/default\/members/member-view/member-view.module#MemberViewModule"
            },
            {
                "path": "member\/edit\/:MemberId",
                "loadChildren": ".\/pages\/default\/members/member-edit/member-edit.module#MemberEditModule"
            },
            {
                "path": "member\/add",
            ...
            {
                "path": "publications",
                "loadChildren": ".\/pages\/default\/publications\/publication-lists\/publication-lists.module#PublicationListsModule"
            },
            {
                "path": "publications\/create",
                "loadChildren": ".\/pages\/default\/publications\/publication-create\/publication-create.module#PublicationCreateModule"
            },
            {
                "path": "publications\/price_management\/add",
                "loadChildren": ".\/pages\/default\/publications\/publications-add\/publications-add.module#PublicationsAddModule"
            },
            {
                "path": "publications\/price_management",
                "loadChildren": ".\/pages\/default\/publications\/publications-add\/price-management-lists\/price-management-lists.module#PriceManagementListsModule"
            },
            {
                "path": "publications\/price_management\/edit\/single\/:singleEdit",
                "loadChildren": ".\/pages\/default\/publications\/publications-add\/single-edit\/price-single-edit.module#PriceSingleEditModule"
            },
            {
                "path": "publications\/price_management\/edit\/bulk\/:bulkEdit",
                "loadChildren": ".\/pages\/default\/publications\/publications-add\/bulk-edit\/price-bulk-edit.module#PriceBulkEditModule"
            },
            {
                "path": "publications\/price_management\/edit\/combo\/:comboEdit",
                "loadChildren": ".\/pages\/default\/publications\/publications-add\/combo-edit\/price-combo-edit.module#PriceComboEditModule"
            },
            {

                "path": "publications\/edit\/:PublicationId",
                "loadChildren": ".\/pages\/default\/publications\/publication-edit\/publication-edit.module#PublicationEditModule"
            },
            {
                "path": "publications\/price-management-single",
                "loadChildren": ".\/pages\/default\/publications\/price-management-single\/price-management-single.module#PriceManagementSingleModule"
            },
            {
                "path": "publications\/price-management-bulk",
                "loadChildren": ".\/pages\/default\/publications\/price-management-bulk\/price-management-bulk.module#PriceManagementBulkModule"
            },
            {
                "path": "publications\/price-management-combo",
                "loadChildren": ".\/pages\/default\/publications\/price-management-combo\/price-management-combo.module#PriceManagementComboModule"
            },
            {
                "path": "publications\/price-management-listing",
                "loadChildren": ".\/pages\/default\/publications\/price-management-listing\/price-management-listing.module#PriceManagementListingModule"
            },
            {
                "path": "publications\/price-master",
                "loadChildren": ".\/pages\/default\/publications\/price-master\/price-master.module#PublicationPriceMasterModule"
            },
            {
                "path": "subscriptions",
                "loadChildren": ".\/pages\/default\/subscriptions\/subscriber-lists\/subscriber-lists.module#SubscriberListsModule"
            },
            {
                "path": "subscriptions/bulk-subscription",
                "loadChildren": ".\/pages\/default\/subscriptions\/bulk-subscription\/bulk-subscription.module#BulkSubscriptionModule"
            },
            {
                "path": "subscriptions/buy-subscription-one",
                "loadChildren": ".\/pages\/default\/subscriptions\/buy-subscription-one\/buy-subscription-one.module#BuySubscriptionOneModule"
            },
            {
                "path": "subscriptions/buy-subscription-two",
                "loadChildren": ".\/pages\/default\/subscriptions\/buy-subscription-two\/buy-subscription-two.module#BuySubscriptionTwoModule"
            },
            {
                "path": "subscriptions/select-payment-methods",
                "loadChildren": ".\/pages\/default\/subscriptions\/select-payment-methods\/select-payment-methods.module#SelectPaymentMethodsModule"
            },
            {
                "path": "subscriptions/buy-subscription-partial-payment",
                "loadChildren": ".\/pages\/default\/subscriptions\/buy-subscription-partial-payment\/buy-subscription-partial-payment.module#BuySubscriptionPartialPaymentModule"
            },
            {
                "path": "subscriptions/subscription-listing",
                "loadChildren": ".\/pages\/default\/subscriptions\/subscription-listing\/subscription-listing.module#SubscriptionListingModule"
            },
            {
                "path": "donations",
                "loadChildren": ".\/pages\/default\/donations\/donation-lists\/donation-lists.module#DonationListsModule"
            },
            {
                "path": "donations\/process-donation",
                "loadChildren": ".\/pages\/default\/donations\/donation-process\/donation-process.module#DonationProcessModule"
            },
            {
                "path": "donations\/cause-management",
                "loadChildren": ".\/pages\/default\/donations\/cause-lists\/cause-lists.module#CauseListsModule"
            },
            {
                "path": "donations\/cause-management\/create",
                "loadChildren": ".\/pages\/default\/donations\/cause-create\/cause-create.module#CauseCreateModule"
            },
            {
                "path": "donations\/cause-management\/edit\/:CauseId",
                "loadChildren": ".\/pages\/default\/donations\/cause-edit\/cause-edit.module#CauseEditModule"
            },
            {
                "path": "donations\/transactions",
                "loadChildren": ".\/pages\/default\/donations\/transactions-lists\/transactions-lists.module#TransactionsListsModule"
            },
            {
                "path": "setting\/coupon",
                "loadChildren": ".\/pages\/default\/settings\/coupon\/coupon-lists\/coupon-lists.module#CouponListsModule"
            },
            {
                "path": "setting\/coupon\/create",
                "loadChildren": ".\/pages\/default\/settings\/coupon\/coupon-add\/coupon-add.module#CouponAddModule"
            }, 
            {
                "path": "setting\/coupon\/edit\/:CouponId",
                "loadChildren": ".\/pages\/default\/settings\/coupon\/coupon-edit\/coupon-edit.module#CouponEditModule"
            },
            {
                "path": "setting\/country",
                "loadChildren": ".\/pages\/default\/settings\/country\/country-lists\/country-lists.module#CountryListsModule"
            },
            {
                "path": "setting\/country\/create",
                "loadChildren": ".\/pages\/default\/settings\/country\/country-add\/country-add.module#CountryAddModule"
            },
            {
                "path": "setting\/country\/edit\/:CountryId",
                "loadChildren": ".\/pages\/default\/settings\/country\/country-edit\/country-edit.module#CountryEditModule"
            },
            {
                "path": "setting\/primary-country",
                "loadChildren": ".\/pages\/default\/settings\/country\/primary-country-lists\/primary-country-lists.module#PrimaryCountryListsModule"
            },
            {
                "path": "setting\/primary-country/create",
                "loadChildren": ".\/pages\/default\/settings\/country\/primary-country-add\/primary-country-add.module#PrimaryCountryAddModule"
            },
            {
                "path": "setting\/primary-country\/edit\/:PrimaryCountryId",
                "loadChildren": ".\/pages\/default\/settings\/country\/primary-country-edit\/primary-country-edit.module#PrimaryCountryEditModule"
            },
            {
                "path": "setting\/states",
                "loadChildren": ".\/pages\/default\/settings\/state\/state-lists\/state-lists.module#StateListsModule"
            },
            {
                "path": "setting\/states\/create",
                "loadChildren": ".\/pages\/default\/settings\/state\/state-add\/state-add.module#StateAddModule"
            },
            {
                "path": "setting\/states\/edit\/:StateId",
                "loadChildren": ".\/pages\/default\/settings\/state\/state-edit\/state-edit.module#StateEditModule"
            },
            {
                "path": "setting\/payments",
                "loadChildren": ".\/pages\/default\/settings\/payment\/payment-lists\/payment-lists.module#PaymentListsModule"
            },
            {
                "path": "setting\/payments\/create",
                "loadChildren": ".\/pages\/default\/settings\/payment\/payment-create\/payment-create.module#PaymentCreateModule"
            },
            {
                "path": "setting\/family-relationship",
                "loadChildren": ".\/pages\/default\/settings\/family-relationship\/family-relationship-lists\/family-relationship-lists.module#FamilyRelationshipListsModule"
            },
            {
                "path": "setting\/family-relationship\/create",
                "loadChildren": ".\/pages\/default\/settings\/family-relationship\/family-relationship-create\/family-relationship-create.module#FamilyRelationshipCreateModule"
            },
            {
                "path": "setting\/family-relationship\/edit\/:FamilyId",
                "loadChildren": ".\/pages\/default\/settings\/family-relationship\/family-relationship-edit\/family-relationship-edit.module#FamilyRelationshipEditModule"
            },
            {
                "path": "setting\/sub-application",
                "loadChildren": ".\/pages\/default\/settings\/sub-application\/sub-application-lists\/sub-application-lists.module#SubApplicationListsModule"
            },
            {
                "path": "setting\/sub-application\/create",
                "loadChildren": ".\/pages\/default\/settings\/sub-application\/sub-application-create\/sub-application-create.module#SubApplicationCreateModule"
            },
            {
                "path": "setting\/sub-application\/edit\/:SubApplicationId",
                "loadChildren": ".\/pages\/default\/settings\/sub-application\/sub-application-edit\/sub-application-edit.module#SubApplicationEditModule"
            },
            {
                "path": "setting\/salutation",
                "loadChildren": ".\/pages\/default\/settings\/salutation\/salutation-lists\/salutation-lists.module#SalutationListsModule"
            },
            {
                "path": "setting\/salutation\/create",
                "loadChildren": ".\/pages\/default\/settings\/salutation\/salutation-create\/salutation-create.module#SalutationCreateModule"
            },
            {
                "path": "setting\/salutation\/edit\/:SalutationId",
                "loadChildren": ".\/pages\/default\/settings\/salutation\/salutation-edit\/salutation-edit.module#SalutationEditModule"
            },
            {
                "path": "setting\/language",
                "loadChildren": ".\/pages\/default\/settings\/language\/language-lists\/language-lists.module#LanguageListsModule"
            },
            {
                "path": "setting\/language\/create",
                "loadChildren": ".\/pages\/default\/settings\/language\/language-create\/language-create.module#LanguageCreateModule"
            },
            {
                "path": "setting\/language\/edit\/:LanguageId",
                "loadChildren": ".\/pages\/default\/settings\/language\/language-edit\/language-edit.module#LanguageEditModule"
            },
            {
                "path": "setting\/region",
                "loadChildren": ".\/pages\/default\/settings\/region\/region-lists\/region-lists.module#RegionListsModule"
            },
            {
