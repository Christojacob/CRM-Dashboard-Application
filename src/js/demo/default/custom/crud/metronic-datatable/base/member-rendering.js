        ...
        columns: [
          {
            ...
            width: 150,
            template: function() {
                var phoneNo = mUtil.getRandomInt(7121421404, 9999999999);
                return phoneNo;
            }
          }, {
            field: 'Status',
            ...
            template: function(data) {
              var status = {
                ...
                2: {'title': 'Blocked', 'class': ' m-badge--danger'},
                3: {'title': 'Deleted', 'class': ' m-badge--warning'},
                4: {'title': 'Not verified', 'class': ' m-badge--info'},
                5: {'title': 'Blocked', 'class': ' m-badge--danger'},
                6: {'title': 'Deleted', 'class': ' m-badge--warning'},
                7: {'title': 'Confirmed', 'class': ' m-badge--success'},
              };
            ...
            template: function(data) {
              var status = {
                ...
                2: {'title': 'Staff', 'state': 'primary'},
                3: {'title': 'Super Admin', 'state': 'accent'},
              };
